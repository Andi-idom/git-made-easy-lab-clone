...
Step 7 — Verify Your Code is on GitHub (or GitLab)
  Go to your repository page on GitHub (or GitLab) and refresh.
  You should see hello-git.txt with your committed changes.
